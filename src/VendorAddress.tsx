...
import { listener } from "./listeners/vendoraddresslistner";
import { workbook } from "./vendoraddressworkbook";
...
export default function VendorAddress() {
  ...
  return (
    <div className="content">
      ...
      <div>
        <button className="contrast" onClick={onOpenSpace}>Vendor Address Import
        </button>
        {showSpace && <Space />}
      </div>
    </div>
